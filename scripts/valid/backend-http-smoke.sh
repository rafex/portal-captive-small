...
(
  cd "$ROOT_DIR"
  java -cp backend/java/portal/services/auth-service/target/auth-service-0.1.0.jar com.portal.auth.AuthApplication "$TMP_CFG" >/tmp/auth-service-smoke.log 2>&1 &
