...
nohup env MQTT_HOST=127.0.0.1 MQTT_PORT="${BROKER_PORT}" SQLITE_DB_PATH="${DATA_DB}" DB_USER_REQUEST_TOPIC="${REQ_TOPIC}" "${ROOT_DIR}/backend/bin/db-mqtt-worker-${ARCH}" >/tmp/db-worker.log 2>&1 </dev/null &
